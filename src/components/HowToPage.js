    ...
    return <Stack spacing={2} sx={{px: 2}}>
        ...
        <Typography component='p' variant='body2'>
            <Trans i18nKey="basic-usage-0">
                You can search the database with <strong>Hangul</strong>, <strong>romanization</strong>, or a <strong>mix of both</strong>, as demonstrated below.
                All queries are automatically converted to romanized form before querying the database, as the internal format of the database is in romanized form.
            </Trans>
        </Typography>
        ...
        <Typography component='p' variant='body2'>
            <Trans i18nKey="basic-usage-1">
                We use a <strong>modified Yale Romanization</strong> system. Here are the most important differences:
            </Trans>
        </Typography>
        ...
        <ul>
            <MarkdownListItem>
                <Trans i18nKey="rom-detail-1">
                    <strong>‘ㅇ’ is always romanized into ‘<code>G</code>’</strong> (a capital G) regardless of the environment it appears in.
                </Trans>
            </MarkdownListItem>
            <MarkdownListItem>
                <Trans i18nKey="rom-detail-2">
                    <strong>Letter blocks are always separated by a ‘<code>.</code>’</strong> (full stop), unless already separated by a space.
                </Trans>
            </MarkdownListItem>
            <MarkdownListItem>
                <Trans i18nKey="rom-detail-3">
                    For ‘ㅛ’ and ‘ㅠ’, we use <strong>‘<code>yo</code>’ and ‘<code>yu</code>’</strong> instead of ‘<code>ywo</code>’ and ‘<code>ywu</code>’.
                </Trans>
            </MarkdownListItem>
            <MarkdownListItem>
                <Trans i18nKey="rom-detail-4">
                    A letter block without an initial letter is romanized as if the initial letter is ‘<code>`</code>’ (a single backtick). For example, ᅟᅵᆫ → <code>`in</code>.
                </Trans>
            </MarkdownListItem>
        </ul>
            ...
            <ul>
                <MarkdownListItem>
                    <Trans i18nKey="wildcard-detail-1">
                        The <code>‘_’</code> (underscore) matches any <strong>one</strong> romanized letter.
                    </Trans>
                </MarkdownListItem>
                <MarkdownListItem>
                    <Trans i18nKey="wildcard-detail-2">
                        The <code>‘%’</code> (percent sign) matches <strong>any number</strong> of letters, including zero.
                    </Trans>
                </MarkdownListItem>
            </ul>
        </Typography>
                ...
                <ul>
                    <MarkdownListItem>
                        <Trans i18nKey="startend-detail-1">
                            To find a sentence that <strong>starts with</strong> a certain phrase, prepend a &ldquo;<code>^</code>&rdquo; (caret) to the query string.
                        </Trans>
                    </MarkdownListItem>
                    <MarkdownListItem>
                        <Trans i18nKey="startend-detail-2">
                            To find a sentence that <strong>ends with</strong> a certain phrase, append a &ldquo;<code>$</code>&rdquo; (dollar sign) to the query string.
                        </Trans>
                    </MarkdownListItem>
                </ul>
            </Typography>
            ...
            <ul>
                <MarkdownListItem>
                    <Trans i18nKey="regex-detail-2">
                        To use regular expressions, start and end your query with a <code>/</code> (slash).
                    </Trans>
                </MarkdownListItem>
                <MarkdownListItem>
                    <Trans i18nKey="regex-detail-3">
                        You can only use romanized letters in regular expressions. Be careful to escape the syllable separator with &ldquo;<code>\.</code>&rdquo;!
                    </Trans>
                </MarkdownListItem>
                <MarkdownListItem>
                    <Trans i18nKey="regex-detail-4">
                        For example, entering <code>/cho\.c[ou]\.ni/</code> will match both <code>cho.co.ni</code> (ᄎᆞᄌᆞ니) and <code>cho.cu.ni</code> (ᄎᆞ즈니).
                    </Trans>
                </MarkdownListItem>
                <MarkdownListItem>
                ...
                <MarkdownListItem>
                    <Trans i18nKey="regex-detail-6">
                        Searching with regular expressions can be slow, especially for complex patterns.
                        If a search takes more than 10 seconds, it will be automatically stopped.
                        In that case, try to narrow down your search term.
                    </Trans>
                </MarkdownListItem>
            </ul>
        </Typography>
